...
/* ==========================================================================
   8. VISUALIZADOR EXECUTIVO DECK MODE (16:9 FULLSCREEN PRESENTATION)
   ========================================================================== */
function initExecutiveDeckViewer() {
  ...
  const openBtns = document.querySelectorAll('.open-deck-btn');
  ...
  function renderSlide(deckKey, slideIdx) {
    ...
    titleEl.textContent = deck.title.toUpperCase();
    progressEl.textContent = `Slide ${slideIdx + 1} de ${slides.length}`;
